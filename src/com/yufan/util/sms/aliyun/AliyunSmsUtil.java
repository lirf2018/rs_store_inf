package com.yufan.util.sms.aliyun;
...
public class AliyunSmsUtil {
    ...
    public JSONObject sendPhoneSms(String phone, String contends, String smsNumber, String sign, String smsModel) {
        ...
        try {
            ...
            String accessKeyId = ConfigProperty.getConfigValue("aliyun.accesskeyid");
            String accessKeySecret = ConfigProperty.getConfigValue("aliyun.accesskeysecret");
